...
public class Practice01 {
	public static void main(String[] args) {
		...
		System.out.println(set); //중복없음 정렬 안되어있음 [1, 20, 7, 10]
		...
		System.out.println(set2); //중복없고 오름차순 정렬 [1, 7, 10, 20]
		...
		System.out.println(set3); //중복없고 내림차순 정렬  [20, 10, 7, 1]
		...
		queue.offer(10);
		queue.offer(1);queue.offer(2);queue.offer(3);queue.offer(4);queue.offer(5);queue.offer(6);
		queue.offer(7);queue.offer(8);queue.offer(9);
...
//            System.out.print(" PARENT : " + queue.toArray()[i] + " LEFT CHILD : " + queue.toArray()[2 * i+1] + " RIGHT CHILD :" + queue.toArray()[2 * i + 2]); 
//            System.out.println(); 
//        } 
